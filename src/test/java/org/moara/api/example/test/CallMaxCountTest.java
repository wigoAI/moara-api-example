package org.moara.api.example.test;

import org.json.JSONObject;
import org.moara.api.example.rest.SimilarityCosine;

/**
 * <pre>
 *  파 일 명 : CallMaxCountTest.java
 *  설    명 : 반복 콜 테스트
 *
 *  작 성 자 : macle(김용수)
 *  작 성 일 : 2019.11
...
public class CallMaxCountTest {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10000; i++) {
            String receiveMessage = SimilarityCosine.call("http://127.0.0.1:33377", messageObj.toString());
            System.out.println(i +" " + receiveMessage);
        }
    }
